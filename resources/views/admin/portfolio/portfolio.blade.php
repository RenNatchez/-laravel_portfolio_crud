...
<div class="container push">
    <div  class="bg-white px-5">
        <div class="d-flex justify-content-between py-3">
            <h1 class="m-0 my-auto display-3">Portfolio</h1>
            <div  class="d-flex  py-3">
                <a href="{{route('admin.home')}}" class="mr-3"><button class="btn btn-dark"><h2 class="display-5">Retour</h2></button></a>
                <a href="{{route('portfolio.create')}}" class="ml-3"><button class="btn btn-dark btn-darkblu"><h2 class="display-5">Ajouter</h2></button></a>
            </div>
        </div>
        ...
        <div class="border border-secondary my-3 d-flex align-items-center justify-content-between  border-top-0  border-left-0 border-right-0">
            <div class="d-flex align-items-center">
                <h5 class="px-3 py-4 mr-5"> ID : {{$folio->id}}</h5>
                <h5 class="px-3 py-4 mr-5"> détail : {{$folio->lien}}</h5>
            </div>
            <div class="d-flex w-25 justify-content-between">
                <a href="{{route('portfolio.show',$folio->id)}}"><button class="btn btn-primary pt-3">
                        <h6 class="display-5">Voir</h6>
                    </button></a>
                <a href="{{route('portfolio.edit', $folio->id)}}"><button class="btn btn-success pt-3">
