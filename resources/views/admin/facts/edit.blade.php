...
<div class="push-left">
    <div class="push-left d-flex align-items-center">
        <img src="{{asset($fact->image)}}" alt="">
        <form method="POST" action="{{route('fact.udapte', $fact->id)}}" class="w-50 mx-auto my-5 px-5">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="image">Choix d'image</label>
            ...
            <div class="form-group">
                ...
                <input value="{{$fact->lien}}" type="text" class="form-control" id="lien" name="lien"
